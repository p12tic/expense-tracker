    ...
    useEffect(() => {
        const FetchAccounts = async () => {
            await AuthAxios.get("accounts", auth.getToken()).then(async (res) => {
                ...
                const Tags: TagElement[] = await AuthAxios.get("tags", auth.getToken()).then(async (tagsRes) => {
                ...
                {acc.isUsed ?
                    <>
                        <Col xs={12} sm={1} className="align-content-center">
                            <Form.Label className="tmp-account-amount-label mb-0">Amount</Form.Label>
                        </Col>
                                ...
                                <Form.Group>
                                    ...
                                    {presets.map((preset, id) => (
                                        presetInUse?.id === preset.id ?
                                            ...
                                            :
                                            <Button variant="default" className="tmp-preset-button"
