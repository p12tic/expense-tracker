    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master_account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='master_account', to='expenses.Account')),
                ('slave_account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='slave_account', to='expenses.Account')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('chained_account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='expenses.ChainedAccount')),
            ],
        ),
        migrations.CreateModel(
