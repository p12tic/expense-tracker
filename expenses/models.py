...
class Subtransaction(models.Model):
    ...
    transaction = models.ForeignKey(
        Transaction, on_delete=models.CASCADE, related_name='subtransactions'
    )

    account = models.ForeignKey(Account, on_delete=models.CASCADE, related_name='subtransactions')
...
class ChainedAccount(models.Model):
    ...
    master_account = models.ForeignKey(
        Account, related_name='master_account', on_delete=models.CASCADE
    )

    slave_account = models.ForeignKey(
        Account, related_name='slave_account', on_delete=models.CASCADE
    )
...
class ChainedAccountRequestPendingNew(models.Model):
    ...
    master = models.ForeignKey(
        settings.AUTH_USER_MODEL, related_name='master', on_delete=models.CASCADE
    )

    slave = models.ForeignKey(
        settings.AUTH_USER_MODEL, related_name='slave', on_delete=models.CASCADE
    )
...
class ChainedSubtransaction(models.Model):
    ...
    master_subtransaction = models.ForeignKey(
        Subtransaction, related_name='master_subtransaction', on_delete=models.CASCADE
    )

    slave_subtransaction = models.ForeignKey(
        Subtransaction, related_name='slave_subransaction', on_delete=models.CASCADE
    )
...
class PresetTransactionTag(models.Model):
    ...
    preset = models.ForeignKey(Preset, on_delete=models.CASCADE, related_name='preset_tags')
...
class PresetSubtransaction(models.Model):
    ...
    preset = models.ForeignKey(
        Preset, on_delete=models.CASCADE, related_name='preset_subtransactions'
    )
...
class AccountBalanceCache(models.Model):
    ...
    account = models.ForeignKey(Account, on_delete=models.CASCADE, related_name='balance_caches')
...
class AccountSyncEvent(models.Model):
    ...
    account = models.ForeignKey(Account, on_delete=models.CASCADE, related_name='sync_events')
