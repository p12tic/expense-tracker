...
urlpatterns = [
    ...
    url(r'^transactions/(?P<pk>\d+)$', transaction.TransactionSubtransactionsListView.as_view()),
    url(r'^transactions/(?P<pk>\d+)/edit$', transaction.TransactionUpdateView.as_view()),
    url(r'^transactions/(?P<pk>\d+)/delete$', transaction.TransactionDeleteView.as_view()),
    url(r'^accounts$', account.AccountListView.as_view()),
    url(r'^accounts/(?P<pk>\d+)$', account.AccountSubtransactionsListView.as_view()),
